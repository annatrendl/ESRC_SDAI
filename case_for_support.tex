...
\caption{The long-lasting effects of domestic abuse, regressions}
  ...
  \centering
    ...
    \toprule
     \textbf{Research question} & \textbf{Dataset}    & \textbf{Unit of analysis} & \textbf{Outcome variables} & \textbf{Explanatory variables} & \textbf{Model} \\
    \midrule
    How does past childhood abuse affect socio-economic outcomes in adulthood? & CSEW & Individual (respondent-level) & Educational attainment, employment status and health-related outcomes, including domestic abuse victimisation & Degree and type of childhood abuse suffered & Propensity score matching \\
                \midrule
                ...
                \midrule
     How does experiences of domestic abuse at home and experiences of child abuse affect behavioural outcomes in childhood? & CSEW & Individual (respondent-level) & Bullying, involvement with gangs, school truancy, carrying knives, drugs and alcohol usage, learning difficulties, health & Degree and type of domestic abuse witnessed/child abuse suffered & Propensity score matching \\
                \midrule
          What proportion of young offenders come from abusive households? & WMP & Young offenders &  &  &  \\
     \bottomrule
  \end{tabular}
    \end{threeparttable}%
  \label{tab:addlabel}%
