...
Our proposal aims to bring a data science approach to the study of domestic abuss, by using large-scale data from West Midlands Police (serving a population of 2.9 million people), Lloyds Banking Group (the UK's largest retail bank with 22 million customers), and the Crime survey for England and Wales (CSEW). Our approach is new and ambitious, and has the potential to derive new insights bout domestic abuse in the UK and complement the existing body of knowledge on the topic, which has been predominantly generated via qualitative research methods, such as case studies and interviews. 
